...
<body>
    ...
    <nav class="navbar">
        <div class="max-width">
            <div class="logo"><a href="#">VK<span>Talreja</span></a></div>
            <ul class="menu">
    ...
    <section class="teams" id="teams">
        <div class="max-width">
            ...
            <div class="carousel owl-carousel">
                <div class="card">
                    <div class="box">
                        <img src="images/javed.jpg" alt="">
                        <div class="text">Javed Ali</div>
                        <p>UI/UX Designer</p>
                    </div>
                </div>
                <div class="card">
                    <div class="box">
                        <img src="images/sandhiya.jpg" alt="">
                        <div class="text">Sandhiya</div>
                    ...
                    <div class="icons">
                        <div class="row">
                            ...
                            <div class="info">
                                ...
                                <div class="sub-title">Vishal Kumar</div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="info">
                                ...
                                <div class="sub-title">vishal.kumar25913@gmail.com</div>
                            </div>
                        </div>
                    </div>
                </div>
